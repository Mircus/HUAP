# Incubator Graph Definitions

These YAML files use an **experimental DSL** (`type: entry/action/branch` with `${state...}` expressions) that is **not yet executed** by the HUAP engine.
